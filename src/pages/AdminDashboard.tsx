        ...
        <nav className="flex-1 p-6 space-y-2">
          {[
            ...
            <button
              ...
              className={`w-full flex items-center gap-4 px-5 py-4 text-sm font-bold uppercase tracking-widest transition-all ${activeTab === item.id ? 'bg-brand-gold text-brand-navy shadow-lg shadow-brand-gold/10' : 'text-brand-grey hover:text-white hover:bg-white/5'}`}
            >
