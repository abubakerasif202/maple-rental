    ...
    <div className="bg-brand-navy min-h-screen py-24 text-white selection:bg-brand-gold selection:text-brand-navy">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-white/10 pb-8">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-gold/10 border border-brand-gold/30 text-brand-gold text-[10px] font-bold tracking-widest uppercase mb-4">
              Our Fleet
            </div>
            <h1 className="text-4xl md:text-6xl font-serif font-bold text-white tracking-tight">Premium Hybrid Vehicles</h1>
            <p className="text-brand-grey mt-4 text-lg font-light max-w-2xl leading-relaxed">Choose from our selection of meticulously maintained Toyota Camry Hybrids, ready for professional Uber drivers.</p>
          </div>
            ...
            {filteredCars.map(car => (
              <div key={car.id} className="bg-brand-navy-light border border-white/10 overflow-hidden hover:border-brand-gold/30 hover:shadow-2xl transition-all duration-500 ease-out group flex flex-col relative">
                <div className="relative h-72 overflow-hidden bg-brand-navy">
                  ...
                  <div className="absolute bottom-4 left-4 bg-brand-navy/80 backdrop-blur-md px-3 py-1 border border-white/10 z-20">
                ...
                <div className="p-8 flex-grow flex flex-col relative z-20">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-[10px] font-bold uppercase tracking-widest text-brand-grey mb-8 border-t border-white/10 pt-6">
                    <div className="flex items-center gap-2 bg-white/5 px-3 py-2 border border-white/5">
                  ...
                  <div className="mt-auto">
                    <Link 
                      ...
                      className={`flex items-center justify-center gap-2 w-full text-center font-bold py-5 transition-all duration-300 uppercase tracking-widest text-xs ${
                        car.status === 'Available' 
                          ? 'bg-brand-gold hover:bg-brand-gold-light text-brand-navy shadow-lg' 
