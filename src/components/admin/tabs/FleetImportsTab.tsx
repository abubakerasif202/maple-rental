        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-brand-navy/80 p-4">
          ...
          >
            ...
            <label className="block text-sm font-bold text-white">
              Source review notes
              <textarea className="mt-2 min-h-24 w-full rounded-xl border border-white/10 bg-white/5 p-3 text-white" value={editNotes} onChange={(event) => setEditNotes(event.target.value)} />
            </label>
